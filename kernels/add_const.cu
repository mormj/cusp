...
template <typename T> __global__ void kernel_add_const(float f, const T *in, T *out, int N) {
...
template <typename T>
void launch_kernel_add_const(float f, const T *in, T *out, int grid_size, int block_size,
...
#define IMPLEMENT_KERNEL(T)                                                    \
  template void launch_kernel_add_const(float f, const T *in, T *out, int grid_size,         \
